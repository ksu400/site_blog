...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220414_e5ada6e4b9a0e4b8ade69687d0bcd0_7f878c1a0922cf6a9683_20220414154644_archive.zip';
	const ARCHIVE_SIZE		 = '26457343';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7f878c1-14154644';
    const SECONDARY_PACKAGE_HASH = 'aa4b3e1-14154644';
	const VERSION			 = '1.4.5';
